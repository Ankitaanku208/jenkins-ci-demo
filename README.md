...
Snyk provides the ability to monitor application runtime behavior and detect when an invocation of a function is known to be vulnerable and used within open source dependencies that the application makes use of.
